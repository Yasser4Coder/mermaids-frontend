...
export function BrandLockup({ footer, textOnly, className }) {
  return (
    <Link
      to="/"
      className={cn("brand-lockup", footer && "brand-lockup--footer", textOnly && "brand-lockup--text", className)}
    ...
    >
      ...
      <span className="brand-lockup__word">
        ...
        {!textOnly && <span className="brand-lockup__sub">Salon &amp; Boutique</span>}
      </span>
    </Link>
  );
}
