...
export default function BeautyGallerySection({ images }) {
  return (
    <section className="py-20 lg:py-28">
      <Container size="lg">
        <div className="text-center font-garamond">
          <h2 className="text-4xl font-bold tracking-wide text-ink sm:text-5xl lg:text-6xl">Gallery</h2>
          <p className="mx-auto mt-4 max-w-xl text-base italic text-charcoal sm:text-lg">
            A glimpse into our salon — hair, nails, makeup, and the art of beauty.
          </p>
        </div>
